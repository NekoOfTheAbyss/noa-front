<template>
  <div class="flex-1 w-full max-w-6xl p-4 mx-auto md:px-8 md:py-16">
    <div class="bg-opacity-20 bg-grayshit-600 text-white">
      ...
      <p class="text-md font-semibold px-8 py-2 tracking-wide leading-9">A <font class="line-through">multipurpose</font> bot for your server! Don't forget to join our support server for frequent giveaways and event info!</p>
